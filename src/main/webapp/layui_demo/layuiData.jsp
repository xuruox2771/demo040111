...
<script>
    layui.use(['form','table','jquery'], function(){
        ...
        var tableinf = table.render({
            elem: '#test'
            ,url:'/demo040111/userControl/userList'
            ...
            ,cols: [[
                ...
                ,{field:'level.levelName', title:'用户名', width:120, edit: 'text'}
                ,{field:'trueName', title:'姓名', width:80, edit: 'text', sort: true}
                ,{field:'adminName', title:'城市', width:100}
                ,{field:'adminName', title:'签名'}
