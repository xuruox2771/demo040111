...
<div class="loginDiv">
	...
	<form action="reg" method="post" id="formreg">
		...
		<div class="formControls">
			<input type="password" name="pwd1" id="pwd1" class="input-text size-L" placeholder="请再次输入您的密码"/>
		</div>
		<div>
			<input type="button" id="regbtn" name="regbtn" value="注册" class="loginBtn">
		</div>
	</form>
